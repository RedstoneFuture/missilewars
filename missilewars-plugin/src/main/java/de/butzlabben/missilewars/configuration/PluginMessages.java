...
public class PluginMessages {
    ...
    public enum MessageEnum {
        ...
        GAME_RESULT_TITLE_WON("game_result.title_won", "%team%"),
        GAME_RESULT_SUBTITLE_WON("game_result.subtitle_won", "&6has won the game!"),
        GAME_RESULT_TITLE_WINNER("game_result.title_winner", "&6Your team"),
        GAME_RESULT_SUBTITLE_WINNER("game_result.subtitle_winner", "&6has won!"),
        GAME_RESULT_TITLE_LOSER("game_result.title_loser", "&8Your team"),
        GAME_RESULT_SUBTITLE_LOSER("game_result.subtitle_loser", "&8has lost!"),
        GAME_RESULT_TITLE_DRAW("game_result.title_draw", "&eDraw!"),
